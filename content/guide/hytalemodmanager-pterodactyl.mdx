---
title: Hytale Mod Manager for Pterodactyl
author: Sarthak
date: 2026-02-07
cover: /hytalemodmanager/banner-pterodactyl.png
---
...
Thank you for purchasing **Hytale Mods Manager for Pterodactyl**!
...
```ts
import HytaleModManagerRoutes from '@/routers/extensions/hytalemodmanager';
```
...
```ts
...HytaleModManagerRoutes,
```

![Hytale Mod Manager Help-1](/hytalemodmanager/help-1.png)
...
```php
@include('layouts.extensions.hytalemodmanager')
```

![Hytale Mod Manager Help-2](/hytalemodmanager/help-2.png)
...
```php
Route::prefix('/extensions/hytalemodmanager')->group(base_path('routes/hytalemodmanager/api-client.php'));
```

![Hytale Mod Manager Help-3](/hytalemodmanager/help-3.png)
...
```php
include 'hytalemodmanager/admin.php';
```

![Hytale Mod Manager Help-4](/hytalemodmanager/help-4.png)
