...
<Callout type="info">
  If you have already completed this step for any of the following extensions — [MC Mods Manager](/products/mcmods-pterodactyl), [MC Modpacks Manager](/products/mcmodpacks-pterodactyl), or [Hytale Mod Manager](/products/hytalemodmanager-pterodactyl) — you do not need to do it again. They all use the same Wings modification.
</Callout>
