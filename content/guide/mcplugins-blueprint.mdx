...
<Callout type="info">
  If you have already completed this step for any of the following extensions — [MC Mods Manager](/products/mcmods-blueprint), [MC Modpacks Manager](/products/mcmodpacks-blueprint), or [Hytale Mod Manager](/products/hytalemodmanager-blueprint) — you do not need to do it again. They all use the same Wings modification.
</Callout>
