...
export default async function GuidePost(props: {
  ...
  const breadcrumbJsonLd: WithContext<BreadcrumbList> = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Guide',
        item: 'https://stellarstudios.xyz/guide',
      },
      {
        '@type': 'ListItem',
        position: 3,
      ...
      <header className="mb-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <ShareButton
            ...
            description={page.data.description}
            url={`https://stellarstudios.xyz${page.url}`}
          />
        </div>
...
export async function generateStaticParams() {
  return guideSource.generateParams().map((params) => ({
    slug: params.slug?.[0] ?? '',
  }));
}
...
export async function generateMetadata(props: {
  ...
  const ogImage = `/guide-og/${params.slug}/image.png`;
