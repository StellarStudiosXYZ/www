...
export const metadata: Metadata = {
  title: 'Blog',
  description: 'Latest updates, tutorials, and insights of StellarStudios.',
};
...
export default function BlogIndex() {
  ...
  const jsonLd: WithContext<Blog> = {
    ...
    '@type': 'Blog',
    name: 'StellarStudios Blog',
    description: 'Latest updates, tutorials, and insights of StellarStudios.',
    url: 'https://stellarstudios.xyz/blog',
    publisher: {
      '@type': 'Organization',
      name: 'StellarStudios',
      logo: {
    ...
    blogPost: posts.map((post) => ({
      ...
      image: post.data.cover
        ? `https://https://stellarstudios.xyz${post.data.cover}`
        : 'https://https://stellarstudios.xyz/logo.png',
    })),
  };
    ...
    <div className="container mx-auto py-12 px-4 max-w-7xl">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground">
          Latest updates, tutorials, and insights of StellarStudios.
        </p>
      </div>
